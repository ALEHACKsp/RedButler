...
VOID ApcpKernelRoutineAlertThreadCallback(_In_ PKAPC Apc, _In_ PKNORMAL_ROUTINE* NormalRoutine,
	_In_ PVOID* NormalContext, _In_ PVOID* SystemArgument1, _In_ PVOID* SystemArgument2) {
...
VOID ApcpKernelRoutineNormalCallback(_In_ PKAPC Apc, _In_ PKNORMAL_ROUTINE* NormalRoutine,
	_In_ PVOID* NormalContext, _In_ PVOID* SystemArgument1, _In_ PVOID* SystemArgument2) {
...
BOOLEAN ApcpShouldSkipThread(_In_ PETHREAD Thread, _In_ BOOLEAN IsWow64) {
...
NTSTATUS ApcpQuerySystemProcessInformation(_Out_ PSYSTEM_PROCESS_INFO* SystemInfo) {
...
NTSTATUS ApcpQueryExecutionOnThread(_In_ PETHREAD Thread, _In_ PVOID Code, _In_ PVOID Param) {
...
NTSTATUS ApcpQueryExecutionOnFirstProcessThread(_In_ PEPROCESS Process,
	_In_ BOOLEAN IsWow64, _In_ PVOID Code, _In_ PVOID Param) {
...
NTSTATUS ApcQueueExecution(_In_ PEPROCESS Process, _In_ BOOLEAN IsWow64, _In_ PVOID Code, _In_ PVOID Param) {
